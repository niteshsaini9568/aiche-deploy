    ...
    <div>
      <div>
        <div className="relative h-full mx-4 sm:mx-6 md:mx-8 lg:mx-12 my-2 shadow-lg">
          ...
          >
            <LazyLoadImage
              src="../../group.jpg" // Ensure this path is correct
          ...
          >
            ...
            <p className="text-slate-50 text-center font-semibold my-3 text-lg sm:text-xl lg:text-xl">
              Discover the talented individuals who drive our success. Our team
              combines diverse skills and passions, working together to innovate
              and excel. Get to know the faces behind our achievements and the
