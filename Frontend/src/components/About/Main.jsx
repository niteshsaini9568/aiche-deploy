  ...
  return (
    <div className="relative h-full mx-4 sm:mx-6 md:mx-8 lg:mx-12 my-2 shadow-lg">
      ...
      >
        ...
        <LazyLoadImage
          src="../../change/about.jpg" // Ensure the path is correct
      ...
      >
        ...
        <p className="text-slate-50 text-center font-semibold my-3 text-lg sm:text-xl lg:text-xl">
          Welcome to the AIChE-RGIPT Student Chapter, where excellence and
          collaboration drive our mission to foster innovation and professional
          growth in chemical engineering.
        </p>
      </div>
    </div>
  );
